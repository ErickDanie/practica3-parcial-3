class Form2{
    constructor(){
        ...
        this.nombreCliente=createElement();
        this.edad=createElement();
        this.apellido=createElement();
        this.id=createElement();
        this.telefono=createElement();
        this.correo=createElement();
        this.tipodeCliente=createElement();
